...
class ExtractEquationTest {
    ...
    void extractTest() throws InvalidReactionException {
        ...
        reaction = ExtractEquation.extract(expected);
    ...
    @Test
    void extractTestAndBalance1() throws InvalidReactionException {
    ...
    @Test
    void extractTestAndBalance2() throws InvalidReactionException {
    ...
    @Test
    void extractTestAndBalance3() throws InvalidReactionException {
    ...
    @Test
    void extractTestAndBalance4() throws InvalidReactionException {
    ...
    @Test
    void extractTestAndBalance5() throws InvalidReactionException {
    ...
    @Test
    void extractTestAndBalanceComplex1() throws InvalidReactionException {
    ...
    @Test
    void extractTestAndBalanceComplex2() throws InvalidReactionException {
    ...
    @Test
    void extractTestAndBalanceComplex3() throws InvalidReactionException {
    ...
    @Test
    void extractTestAndBalanceComplex4() throws InvalidReactionException {
    ...
    @Test
    void extractTestAndBalanceComplex5() throws InvalidReactionException {
